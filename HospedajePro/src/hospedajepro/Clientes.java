...
public class Clientes extends javax.swing.JInternalFrame {
    ...
    private void RegistrarDatos() {
        ...
        try{ 
            ...
            consulta = "INSERT INTO CLIENTE (nombre, apellido, dni, telefono, direccion)" + "VALUES (?,?,?,?,?)" ;
                    
             // Preparar la consulta
            PreparedStatement pstmt = con.prepareStatement(consulta);
            pstmt.setString(1, dts.getNombre());
            pstmt.setString(2, dts.getApellido());
            pstmt.setString(3, dts.getDNI());
            pstmt.setString(4, dts.getTelefono());
            pstmt.setString(5, dts.getDireccion());
    ...
    private void initComponents() {
        ...
        label6.setText("REGISTRO DE CLIENTES");
        ...
        txtDNI.setMinimumSize(new java.awt.Dimension(8, 8));
        ...
        jScrollPane1.setName("spanelCliente"); // NOI18N
