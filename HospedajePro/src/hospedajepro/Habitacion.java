...
public class Habitacion extends javax.swing.JInternalFrame {
    ...
    private void RegistrarDatos() {
        ...
        try{ 
            ...
            dts.setNombre(cboTipoHabitacion.getSelectedItem().toString());
            dts.setNumero(txtNhabitacion.getText());
            double precio = Double.parseDouble(txtPrecio.getText());
            dts.setPrecio(precio);
            dts.setPiso(txtPiso.getText());
            ...
            consulta = "INSERT INTO HABITACION (nombre, numero, precio, piso, descripcion, estado)" + "VALUES (?,?,?,?,?,?)" ;
            
             // Preparar la consulta
            PreparedStatement pstmt = con.prepareStatement(consulta);
            pstmt.setString(1, dts.getNombre());
            pstmt.setString(2, dts.getNumero());
            pstmt.setDouble(3, dts.getPrecio());
            pstmt.setString(4, dts.getPiso());
            pstmt.setString(5, dts.getDescripcion());
    ...
    private void initComponents() {
        ...
        txtNhabitacion = new java.awt.TextField();
        ...
        label1.setText("REGISTRO DE HABITACION");
        ...
        txtNhabitacion.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        btnBorrar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Files/eliminar.png"))); // NOI18N
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(txtNhabitacion, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(ListarDatos, javax.swing.GroupLayout.DEFAULT_SIZE, 635, Short.MAX_VALUE)
                .addContainerGap())
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(ListarDatos, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private java.awt.TextField txtNhabitacion;
